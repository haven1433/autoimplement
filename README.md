*Build Note: The code generated by AutoImplement is compatible with .net 3.5 and above. However, the building the generator code (this project) uses C# 7 features and .net 4.7.1.*
